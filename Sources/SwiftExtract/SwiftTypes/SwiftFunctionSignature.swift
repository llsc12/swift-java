...
public enum SwiftGenericRequirement: Equatable {
...
public struct SwiftFunctionSignature: Equatable {
  public var selfParameter: SwiftSelfParameter?
...
public enum SwiftSelfParameter: Equatable {
...
extension AccessorBlockSyntax {
  public struct SupportedAccessorKinds: OptionSet {
    ...
    public static var get: Self = .init(rawValue: 1 << 0)
    public static var set: Self = .init(rawValue: 1 << 1)
  }

  /// Determine what operations (i.e. get and/or set) supported in this `AccessorBlockSyntax`
  public func supportedAccessorKinds() -> SupportedAccessorKinds {
