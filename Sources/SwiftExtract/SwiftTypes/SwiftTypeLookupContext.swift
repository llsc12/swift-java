...
public class SwiftTypeLookupContext {
  ...
  public func moduleQualifiedLookup(name: String, in moduleName: String) -> SwiftTypeDeclaration? {
  ...
  public func unqualifiedLookup(name: Identifier, from node: some SyntaxProtocol) throws -> SwiftTypeDeclaration? {
  ...
  public func typeDeclaration(for node: some SyntaxProtocol, sourceFilePath: String) throws -> SwiftTypeDeclaration? {
  ...
  public func resolve(typeAlias decl: SwiftTypeAliasDeclaration) throws -> SwiftType {
...
public enum TypeLookupError: Error {
  case notType(Syntax)
}
