...
public struct SwiftTupleElement: Equatable, CustomStringConvertible {
  public var label: String?
  public var type: SwiftType

  public init(label: String? = nil, type: SwiftType) {
    self.label = label
    self.type = type
  }
...
public enum SwiftType: Equatable {
  ...
  public var asNominalTypeDeclaration: SwiftNominalTypeDeclaration? {
  ...
  public var isArchDependingInteger: Bool {
    switch self {
    case .nominal(let nominal):
      switch nominal.nominalTypeDecl.knownTypeKind {
      case .int, .uint: true
  ...
  public var isRawTypeCompatible: Bool {
    switch self {
    case .nominal(let nominal):
      switch nominal.nominalTypeDecl.knownTypeKind {
...
public struct SwiftNominalType: Equatable {
  public indirect enum Parent: Equatable {
    case nominal(SwiftNominalType)
  }

  public enum SugarName: Equatable {
    case optional
    case array
    case dictionary
  }
  ...
  public var sugarName: SugarName?
  public var nominalTypeDecl: SwiftNominalTypeDeclaration
  ...
  public var parent: SwiftNominalType? {
...
extension SwiftType {
          ...
          case .nominal(let synth) = self
        {
          self = .nominal(
            SwiftNominalType(
              ...
              nominalTypeDecl: synth.nominalTypeDecl,
  ...
  public func substituting(genericParameters substitutions: [String: SwiftType]) -> SwiftType {
  ...
  /// Swift source code.
  public var metatypeReferenceExprSyntax: ExprSyntax {
...
public enum TypeTranslationError: Error {
...
extension SwiftNominalTypeDeclaration {
  public var asSwiftNominalType: SwiftNominalType {
